...
// Each is generated by recoloring the white body of assets/neko.png.
...
func (m *neko) setColor(color string) bool {
...
func (m *neko) applyCustomColor(hex string) bool {
